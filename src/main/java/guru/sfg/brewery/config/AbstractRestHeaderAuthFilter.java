 ...
 */
@Slf4j
public abstract class AbstractRestHeaderAuthFilter extends AbstractAuthenticationProcessingFilter {  //  AbstractAuthenticationProcessingFilter 해당 필터를 구현하여 인증 프로세스를 완성한다.
